...
Upgraded [🚚 Retouren App](https://github.com/luiul/retoure) with Sequelize migration and seeding to improve reproducibility. Unlisted Youtube [🚚 Retoure App Demo](https://youtu.be/yIhD226f2Mk). Prerequisites to run the app:
